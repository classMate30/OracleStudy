...
2	SLXX.EMNAP              \AAA\:C                         → 최초 『\』등장위치 : 12 → 1 ~ 11 추출
...
FROM DUAL;
--==>> 1	0	-1
--> 매출이나 수지와 관련하여 적자 및 흑자의 개념을 나타낼때 종종 사용된다
...
--==>>
/*
2022-08-17 11:38:15	        → 현재
2022-10-17 11:38:15	        → 2개월 후	
2022-11-17 11:38:15	        → 3개월 후	
2022-06-17 11:38:15	        → 2개월 전	
2022-05-17 11:38:15	        → 3개월 전
*/
--> 월을 더하고 빼기
...
SELECT ADD_MONTHS(SYSDATE,22) "전역일"
    , (ADD_MONTHS(SYSDATE,22) - SYSDATE) *3 "끼니수"
FROM DUAL;
...
--    ,  ((TO_DATE('2023-01-16 18:00:00' ,'YYYY-MM--DD HH24:MI:SS') - SYSDATE) /(24*60))  "분"
...
SELECT SYSDATE "현재시각"
     ...
     , TRUNC((TO_DATE('2023-01-16 18:00:00', 'YYYY-MM-DD HH24:MI:SS') - SYSDATE - TRUNC(TO_DATE('2023-01-16 18:00:00', 'YYYY-MM-DD HH24:MI:SS') - SYSDATE))*24) "시간"
     , MOD(TRUNC((TO_DATE('2023-01-16 18:00:00', 'YYYY-MM-DD HH24:MI:SS') - SYSDATE - TRUNC(TO_DATE('2023-01-16 18:00:00', 'YYYY-MM-DD HH24:MI:SS') - SYSDATE))*24*60),60) "분"
     , MOD(TRUNC((TO_DATE('2023-01-16 18:00:00', 'YYYY-MM-DD HH24:MI:SS') - SYSDATE - TRUNC(TO_DATE('2023-01-16 18:00:00', 'YYYY-MM-DD HH24:MI:SS') - SYSDATE))*24*60*60),60) "초"
FROM DUAL;
--==>>152.149375 일
...
SELECT SYSDATE "현재시각"
    ,  TRUNC(TO_DATE('2023-01-16 18:00:00','YYYY-MM-DD HH24:MI:SS')-SYSDATE,0)"일"
    ,  TRUNC(24*(TO_DATE('2023-1-16 18:00:00','YYYY-MM-DD HH24:MI:SS')-SYSDATE - TRUNC(TO_DATE('2023-1-16 18:00:00', 'YYYY-MM-DD HH24:MI:SS')-SYSDATE))) "시간"
    ,  MOD(TRUNC((60*24*(TO_DATE('2023-1-16 18:00:00','YYYY-MM-DD HH24:MI:SS')-SYSDATE 
    -TRUNC(TO_DATE('2023-1-16 18:00:00','YYYY-MM-DD HH24:MI:SS')-SYSDATE)))),60)"분"  
    ,  MOD(TRUNC(24*60*60*(TO_DATE('2023-1-16 18:00:00','YYYY-MM-DD HH24:MI:SS')-SYSDATE -
    TRUNC(TO_DATE('2023-1-16 18:00','YYYY-MM-DD HH24:MI:SS')-SYSDATE))),60)"초"
FROM DUAL;
...
SELECT TO_CHAR(SYSDATE, 'YYYY-MM-DD')"COL1"         --2022-08-17
    ...
    ,  TO_CHAR(SYSDATE, 'SSSSS')"COL17"             --62635    --금일 00시 00분 00초부터 현재까지 흘러온 '초'
...
SELECT TO_CHAR(SYSDATE,'YYYY')"COL1"            --2022(문자형)      -연도를 추출하여 문자 타입으로...
    ...
    ,  EXTRACT(YEAR FROM SYSDATE) "COL4"        --2022(숫자형)      -연도를 추출하여 숫자타입으로
    ,  EXTRACT(MONTH FROM SYSDATE) "COL5"        --8(숫자형)        -월을 추출하여 숫자타입으로
